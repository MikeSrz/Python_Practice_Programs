...
"""
##########################################################
#Directorio donde se encuentra la base de datos sqlite
...
def main():
    ...
    while not exit:
        ...
        match (option):
            case 1:
                mostrar_ranking(Continentes.AFRICA.value, dict_continentes)
            case 2:
                mostrar_ranking(Continentes.EUROPE.value, dict_continentes)
            case 3:
                mostrar_ranking(Continentes.NOAMERICA.value, dict_continentes)
            case 4:
                mostrar_ranking(Continentes.SUAMERICA.value, dict_continentes)
            case 5:
                mostrar_ranking(Continentes.ASIA.value, dict_continentes)
            case 6:
                mostrar_ranking(Continentes.OCEANIA.value, dict_continentes)
            case 7:
                exit = True
            case _:
